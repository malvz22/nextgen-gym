  ...
  return (
    <>
      <div className="w-full max-w-full relative h-[1024px] flex flex-row justify-center lg:justify-start items-center bg-[url('/gym-hero.jpg')] bg-cover bg-top filter">
        <div className="lg:bg-gradient-to-r bg-gradient-to-b from-black/60 to-black/20 mix-blend-normal w-full max-w-full h-full flex justify-center items-center px-4 md:px-24">
          <div className="w-full max-w-[1240px] mx-auto flex lg:justify-start justify-center items-center">
            <div className="flex flex-col w-full max-w-[600px] lg:px-0 justify-center items-center lg:justify-start lg:items-start text-center lg:text-start">
              <h1 className="text-[50px] sm:text-[70px] md:text-[122px] md:leading-[136px] animate-slide-in">
              ...
              <div className="flex flex-row gap-3 sm:gap-10">
                <div className="flex flex-col justify-center items-center gap-3 md:gap-5 animate-slide-in-bottom">
